 ...
 */
public class ServiceBusTopicTriggerFunctionStockPortFolioSubA2 {
    /**
     * This function listens at endpoint "/api/HttpExample". Two ways to invoke it using "curl" command in bash:
     * 1. curl -d "HTTP Body" {your host}/api/HttpExample
     * 2. curl "{your host}/api/HttpExample?name=HTTP%20Query"
     */
    @FunctionName("FunctionTopicStockPortSubA2")
    public void run(
    		@ServiceBusTopicTrigger(name = "SUBA2TopicItemListner", dataType="binary", topicName = "stockquoteprice",
