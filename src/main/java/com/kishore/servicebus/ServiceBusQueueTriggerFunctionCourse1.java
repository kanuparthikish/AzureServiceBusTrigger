 ...
 */
public class ServiceBusQueueTriggerFunctionCourse1 {
    /**
     * This function listens at endpoint "/api/HttpExample". Two ways to invoke it using "curl" command in bash:
     * 1. curl -d "HTTP Body" {your host}/api/HttpExample
     * 2. curl "{your host}/api/HttpExample?name=HTTP%20Query"
     */
    @FunctionName("FunctionCourseQueue1")
    public void run(
    		@ServiceBusQueueTrigger(name = "CourseQueueSecondListner", dataType="binary", queueName = "coursequeue", connection = "serviceBusConnection")  byte[] message,
